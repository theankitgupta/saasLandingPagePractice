    ...
    /* LAYOUT CONTAINER (The Canvas)
      ...
      - `px-12`: Adds horizontal padding.
          *TEMPLATE NOTE*: This ensures content never hits the very edge of the screen. 
          For mobile specifically, `px-4` is often safer, but `px-12` works well for a spacious desktop look.
    */
    <section className="py-24 px-12">
      ...
      */}
      <div className="container mx-auto">
        ...
        */}
        <p className="text-center text-xl text-white/50 mt-8 px-8">
        ...
        */}
        <form className="flex justify-between border border-white/15 rounded-full p-2 mt-8">
          <input
            ...
            className="px-4 bg-transparent outline-none"
          />
          <Button
            type="button"
            variant="primary"
